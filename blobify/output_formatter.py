...
from .content_processor import scrub_content, get_file_metadata, SCRUBADUB_AVAILABLE
...
def format_output(discovery_context: Dict, directory: Path, context: str, scrub_data: bool, 
                 include_line_numbers: bool, include_index: bool, debug: bool, 
                 blobify_patterns_info: tuple) -> tuple:
    """
    ...
    content_section, total_substitutions = generate_content(
        all_files, scrub_data, include_line_numbers, debug
    )
